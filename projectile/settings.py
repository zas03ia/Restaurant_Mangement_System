...
SECRET_KEY = "django-insecure-#bmte3*xy##@hy4=s=vdrf^7gifczhc-#ho8+(xt3(73xuus@g"
...
DATABASES = {
    "default": {
        ...
        "NAME": "restaurant_management",  # Replace with database name
        "USER": "postgres",  # Replace with PostgreSQL username
        "PASSWORD": "mypostgres",  # Replace with PostgreSQL password
